#!/usr/bin/env python3
"""
rq1_SepsisDRVA.py  —  RQ1 FDR Control Validity: DRVA Baseline — Sepsis ICU
============================================================================
...
RQ1_OUTPUT_DIR  = "RQ1_Sepsis_DRVA"
...
def load_data() -> dict:
    """
    Load the Sepsis ICU event log and build the shared M_all candidate pool.
...
def compute_and_save_metrics(
    ...
    print(f"\n  FDR Results (Sepsis DRVA, B_null={B_NULL}, double-null protocol):")
    print(f"  {'─'*80}")
...
def main():
    print("\n" + "=" * 100)
    print("RQ1 — FDR CONTROL VALIDITY: DRVA BASELINE — SEPSIS ICU")
    ...
    print(f"\n{'='*100}")
    print("RQ1 — DRVA SEPSIS COMPLETE  (double-null protocol)")
    print(f"{'='*100}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="RQ1 FDR Validity — DRVA Baseline, Sepsis ICU (double-null protocol)"
    )
    parser.add_argument(
