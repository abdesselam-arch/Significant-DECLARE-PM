"""
declareminer_BPI_17_parallel.py  —  DeclareMiner Differential Baseline: BPI Challenge 2017
============================================================================================
...
OUTPUT_DIR        = "DeclareMiner_BPI_17"
...
def compute_support_and_confidence(
    ...
    Args:
        ...
        ids_class0:  Set of case IDs for class 0 (Normal/Accepted).
        ids_class1:  Set of case IDs for class 1 (Deviant/Not-Accepted).
...
def run_declareminer(
    ...
    """
    Execute the full DeclareMiner differential threshold pipeline on BPI_17.
    ...
    n0 = len(ids_class0)
    n1 = len(ids_class1)
    print(f"   L_0 (Accepted (Normal), class 0): {n0:,} traces")
    print(f"   L_1 (Deviant (Not-Accepted), class 1): {n1:,} traces")
    ...
    # Direction: class 1 (Deviant/Not-Accepted) has higher confidence
...
def save_outputs(dm_out: dict) -> None:
    ...
    full_json = {
        ...
        'description': {
            ...
            'fdr_note': (
                ...
                "(BPI_17: Deviant (Not-Accepted) vs. Normal (Accepted))."
            ),
    ...
    lines.append("BPI_17: Deviant (Not-Accepted) vs. Normal (Accepted)")
    lines.append("=" * 120)
...
def main():
    parser = argparse.ArgumentParser(
        description="DeclareMiner Differential Threshold Baseline — BPI_17"
    )
    parser.add_argument(
    ...
    print("BPI_17: Deviant (Not-Accepted) vs. Normal (Accepted)")
    print("=" * 100)
