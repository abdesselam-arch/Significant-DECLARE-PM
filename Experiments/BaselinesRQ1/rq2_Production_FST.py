#!/usr/bin/env python3
"""
rq2_Production_FST.py  —  RQ2 Specification Quality Degradation: Production  [DeclareMiner FST / Option A]
==========================================================================================================
...
Production event log: Deviant vs. Normal
...
RQ2_OUTPUT_DIR = "RQ2_Production_FST"
...
def run_original_data_dm() -> dict:
    """
    Run DeclareMiner on the original (unperturbed) Production log.

    Delegates to run_declareminer() from DeclareMiner_Production.py.
...
def main():
    print("\n" + "=" * 100)
    print("RQ2 — SPECIFICATION QUALITY DEGRADATION: PRODUCTION  [DeclareMiner FST / Option A]")
    ...
    # Section 4: summary
    print(f"\n{'='*100}")
    print("RQ2 — PRODUCTION DeclareMiner FST COMPLETE  (Joint Noise, single method)")
    print(f"{'='*100}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=(
            "RQ2 Specification Degradation — Production (DeclareMiner FST / Option A baseline)  "
