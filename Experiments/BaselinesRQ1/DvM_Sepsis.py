...
OUTPUT_DIR        = "DvM_BISE2025_Sepsis"
...
# ══════════════════════════════════════════════════════════════════════════════
# SECTION 1: DECLARE TEMPLATES (positional trace format)
# ══════════════════════════════════════════════════════════════════════════════
#
# Trace format (positional): dict mapping activity_name → sorted list of
# integer positions. E.g. {"A": [0, 3], "B": [1], "C": [2, 4]}
# This mirrors the "events" field in the reference implementation's
# xes_to_positional() output.
#
# Return value: (int, bool) = (result, is_vacuous)
#   result = −1 (violated), 0 (vacuous), n ≥ 1 (n activations satisfied)
...
def apply_declare_template(
    ...
    """Dispatch to evaluate_pattern_fast from p1. Returns (value, is_vacuous)."""
    activity_a = acts[0]
...
def main() -> None:
    ...
    print("Sequential and Declarative Patterns — Sepsis ICU")
