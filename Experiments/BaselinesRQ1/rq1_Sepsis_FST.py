#!/usr/bin/env python3
"""
rq1_Sepsis_FST.py  —  RQ1 FDR Control Validity: Sepsis ICU  [DeclareMiner FST / Option A]
============================================================================================
...
def run_dm_original() -> dict:
    """
    Run the full DeclareMiner FST pipeline on the real Sepsis data.

    Delegates entirely to run_declareminer() from DeclareMiner_Sepsis.py.
...
def main():
    print("\n" + "=" * 100)
    print("RQ1 — FDR CONTROL VALIDITY: SEPSIS ICU  [DeclareMiner FST / Option A]")
    ...
    print(f"\n{'='*100}")
    print("RQ1 — SEPSIS DeclareMiner FST COMPLETE  (double-null, DM-FST only)")
    print(f"{'='*100}")
