...
LOG_CONFIGS = {
    'Sepsis': {
        ...
        'phase1_dir': 'Sepsis_ThreeHyp_SAM_Parallel',
        'phase1_json': 'Sepsis_ThreeHyp_SAM_Parallel/three_hypothesis_samfdr_results.json',
...
def main():
    ...
    print("Version 3.0 — SEPSIS — DIRECTION-AWARE")
    print("=" * 100)
    print(f"\n🎯 EXPERIMENTAL DESIGN:")
