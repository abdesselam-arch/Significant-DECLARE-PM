#!/usr/bin/env python3
"""
rq1_RTFMP.py  —  RQ1 FDR Control Validity: RTFMP (Imbalanced Stress-Test)
=============================================================================
...
Label definition (Teinemaa et al. TKDE 2019 — canonical RTFMP binary outcome):
    Deviant (1): "Send for Credit Collection" appears anywhere in the case
    Normal  (0): "Send for Credit Collection" absent from the case
...
In RTFMP, many patterns have structural signal visible in any random class
partition (pi0_struct < 1).  The Fisher statistic for those patterns remains
shifted rightward:
...
from Experiments.P1_SDSM.p1_RTFMP import (
...
RQ1_OUTPUT_DIR = "../Experiments data/Experiments/Results/RQ1_RTFMP"
...
def compute_and_save_metrics(
    ...
    full_json['null_protocol'] = {
        ...
        'why_label_only_fails': (
            ...
            'ChainResponse(Create Fine, Send Fine) in RTFMP), structural p-values '
...
def main():
    print("\n" + "=" * 100)
    print("RQ1 — FDR CONTROL VALIDITY: RTFMP (Imbalanced Stress-Test)")
