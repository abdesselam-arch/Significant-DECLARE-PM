#!/usr/bin/env python3
"""
rq1_Production_parallel.py  —  RQ1 FDR Control Validity: Production
================================================================
...
-----------------------------------------------
    1.  P1  (Ours)       Hou-Storey conjunction + Adaptive Storey FDR gate.
                         ...
                         Aligned with p1_Production_hou.py v9.0-HOU-DOUBLY-NULL.
    ...
    2.  DRVA             Cecconi et al. (BPM Forum 2021).
                         ...
                         Imported from drva_Production_parallel.py.
    ...
    3.  DeclareMiner     Differential confidence threshold baseline.
                         ...
                         Imported from declareminer_Production_parallel.py.
...
Version : 1.0  (Hou-Storey + DRVA + DeclareMiner; single gate; aligned with
               p1_Production_hou.py v9.0-HOU-DOUBLY-NULL)
...
# File: p1_Production_hou.py  (v9.0-HOU-DOUBLY-NULL)
...
# ── DRVA baseline ─────────────────────────────────────────────────────────
# File: drva_Production_parallel.py  (v2.1)
...
# File: declareminer_Production_parallel.py  (v2.0)
...
# ── Permutation budgets ────────────────────────────────────────────────────
# Original P1 run: matches p1_Production_hou CONFIG exactly.
...
def run_p1_original(n_workers: int = 1) -> dict:
    ...
    The full budget matches p1_Production_hou CONFIG:
    ...
    full_json = {
        ...
        'alignment_with_p1': {
            ...
            'single_gate': (
                ...
                'Matches p1_Production_hou.py v9.0-HOU-DOUBLY-NULL. '
...
def main():
    print("\n" + "=" * 100)
    print("RQ1 — FDR CONTROL VALIDITY: PRODUCTION")
    ...
    print(f"\n{'='*100}")
    print("RQ1 — PRODUCTION COMPLETE  (double-null, three-method comparison)")
    print(f"{'='*100}")
